...
export const POSTS = [
  ...
  // ── Post 1 ──
  {
    ...
    // ✅ CHANGED: content ab array hai — text aur image blocks
    content: [
      {
        type: "text",
        value: `
...
As you ponder your selections, it's vital that you do not forget the level they've obtained and the projects they have worked on. The other factor to bear in mind whilst seeking out the [Best Digital Marketing Companies in Zirakpur](https://arbajtechnologypvtltd.com/) is whether or not they can show their success and success. Even if they do not enjoy your industry of interest, they want in an effort to show their achievement and achievement in associated fields.
...
It is always a very good idea to choose an organization that offers a huge range of offerings, as this will make certain a higher diploma of coordination in advertising strategies. It is always advised to opt for businesses that offer an extensive variety of offerings, as this will ensure a higher diploma of coordination in advertising strategies, as seen with the pleasant virtual advertising corporations in Zirakpur.
      ...
      { type: "image", src: image4, alt: "Best Digital Marketing Companies in Zirakpur" },
