...
export const TEAM = [
  {
    ...
    name: "Arbaj Khan",
    role: "Founder & CEO",
    bio: "Visionary leader with 8+ years in digital marketing and product strategy.",
    socials: ["Li", "Gh", "Tw"],
    color: "#1d7afc",
  },
  {
    ...
    name: "Sara Raza",
    role: "Lead Designer",
    bio: "Crafts intuitive UI/UX experiences that users love and businesses trust.",
    socials: ["Li", "Be", "Dr"],
    color: "#f4a200",
  },
  {
    ...
    bio: "Architect of robust APIs and scalable systems powering our platforms.",
    socials: ["Li", "Gh"],
    color: "#22c55e",
  },
  {
    ...
    name: "Nadia Patel",
    role: "SEO Specialist",
    bio: "Data-driven SEO expert helping brands rank #1 and grow organic traffic fast.",
    socials: ["Li", "Tw"],
    color: "#a855f7",
  },
];
